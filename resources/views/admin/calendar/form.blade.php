        ...
        <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('title') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <input type="text" class="form-control"  placeholder="Tiêu đề công việc" name="title" value="{{ old('title',isset($calendar) ? $calendar->title : '') }}">
                        ...
                        <div class="row">
                            <div class="form-group {{ $errors->first('start_date') ? 'has-error' : '' }} col-md-6">
                                ...
                                <div>
                                    <input type="date" class="form-control" name="start_date" value="{{ old('start_date',isset($calendar) ? $calendar->start_date : '') }}">
                            ...
                            <div class="form-group {{ $errors->first('end_date') ? 'has-error' : '' }} col-md-6">
                                ...
                                <div>
                                    <input type="date" class="form-control" name="end_date" value="{{ old('end_date',isset($calendar) ? $calendar->end_date : '') }}">
                        ...
                        <div class="row">
                            <div class="form-group {{ $errors->first('contents') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="contents" id="contents" cols="30" rows="10" class="form-control">{!! old('contents', isset($calendar) ? $calendar->contents :'') !!}</textarea>
                                    <script>
                                        ckeditor(contents);
                                    </script>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="btn-set">
                            <button type="submit" name="submit" value="{{ isset($calendar) ? 'update' : 'create' }}" class="btn btn-info">
                        ...
                        <div class="col-sm-12">
                            <select name="status" class="form-control">
                                @foreach($status as $key => $item)
                                    <option  {{old('status', isset($calendar) ? $calendar->status : '') == $key ? 'selected=selected' : '' }}  value="{{$key}}">{{$item}}</option>
                                @endforeach
                            </select>
