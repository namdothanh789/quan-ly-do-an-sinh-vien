                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools">
                                <div class="btn-group">
                                    @if ($user->can(['toan-quyen-quan-ly', 'tao-moi-vai-tro']))
                            ...
                            <table class="table table-hover table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Mô tả</th>
                                        @if ($user->can(['toan-quyen-quan-ly', 'chinh-sua-vai-tro', 'xoa-vai-tro']))
                                        ...
                                        @foreach($roles as $role)
                                            <tr>
                                                ...
                                                <td class="text-center" style="vertical-align: middle;">
                                                    @if ($user->can(['toan-quyen-quan-ly', 'chinh-sua-vai-tro']))
                                                    <a class="btn btn-primary btn-sm" href="{{ route('role.update', $role->id) }}">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    @endif
                                                    @if ($user->can(['toan-quyen-quan-ly', 'xoa-vai-tro']))
