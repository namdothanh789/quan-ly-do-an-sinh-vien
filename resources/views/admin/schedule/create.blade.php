...
@section('title', 'Tạo mới lịch hẹn')
@section('content')
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group {{ $errors->first('n_title') ? 'has-error' : '' }} col-md-6">
                                        ...
                                        <div>
                                            <input type="text" maxlength="100" class="form-control"  placeholder="Tiêu đề lịch hẹn" name="n_title" value="{{ old('n_title') }}">
                                ...
                                <div class="form-group {{ $errors->first('n_content') ? 'has-error' : '' }}">
                                    ...
                                    <div>
                                        <textarea name="n_content" id="n_content" style="resize:vertical" class="form-control" placeholder="Mô tả chức vụ ...">{{ old('n_end_date') }}</textarea>
                                        <script>
                                            ckeditor(n_content);
                                        </script>
