                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8" style="flex-basis: unset !important;">
                            <h3 class="mb-0" style="text-transform: uppercase;">CHỈNH SỬA LỊCH HẸN </h3>
                        </div>
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group {{ $errors->first('n_title') ? 'has-error' : '' }} ">
                                                ...
                                                <div>
                                                    <input type="text" maxlength="100" class="form-control"  placeholder="Tiêu đề" name="n_title" value="{{ $notification->n_title }}">
                                                    ...
                                                    <div>
                                                        <select name="n_schedule_type" class="form-control" id="scheduleType">
                                                            @foreach($schedule_types as $key => $type)
                                                                <option  {{$notification->n_schedule_type == $key ? 'selected' : '' }}  value="{{$key}}">{{$type}}</option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <div>
                                                            <select name="users[]" class="form-control select2" multiple="multiple" id="users">
                                                                @foreach($sameTopicStudentList as $student)
                                                                    <option value="{{ $student->id }}" {{ in_array($student->id, $notifiedStudentList) ? 'selected' : '' }}>{{ $student->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            <span class="text-danger">
